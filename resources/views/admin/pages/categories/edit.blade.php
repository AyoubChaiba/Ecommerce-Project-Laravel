...
<div class="content-wrapper">
    @include("admin.partiels.content-header",['text' => 'Edit Category'])
    <section class="content">
        <form action="{{ route('category.update',$category->id) }}" method="POST" enctype="multipart/form-data" class="container-fluid">
            @csrf
            @method('PUT')
            <div class="card">
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                @isset($category->image)
                                    <img src="{{ asset('storage/'.$category->image) }}" alt="" width="155">
                                @endisset
                            </div>
                        </div>
                    </div>
